...
<?php
        ...
        $link_fin =  "00000000001001&ticket=&scale=135";
        ...
        for ($i=1; $i < 20; $i++) { 
            ...
            try{
            $data = file_get_contents($link_completo."$i");
            }
            catch(Exception $e){
            ...
            $base64_1 = 'data:image/' . pathinfo($link_completo, PATHINFO_EXTENSION) . ';base64,' . base64_encode($data);

            echo  "<img src=$base64_1>";
        }
